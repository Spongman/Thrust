...
declare namespace p5 {
  ...
  class Signal {
    // TODO: Fix p5.Signal() errors in lib/addons/p5.sound.js, line 4261:
    //
    ...
    // TODO: Fix add() errors in lib/addons/p5.sound.js, line 4330:
    //
    //   return has invalid type: p5.SignalAdd
    //
    // add(number: number): any
    
    // TODO: Fix mult() errors in lib/addons/p5.sound.js, line 4349:
    //
    //   return has invalid type: Tone.Multiply
    //
    // mult(number: number): any
    
    // TODO: Fix scale() errors in lib/addons/p5.sound.js, line 4368:
    //
  ...
  class Effect {
    // TODO: Fix p5.Effect() errors in lib/addons/p5.sound.js, line 7677:
    //
    ...
    //
    // constructor(ac?: any, input?: any, output?: any, _drywet?: any, wet?: any)
     ...
     *   Example usage: filter.chain(reverb, delay, 
     *   panner); May be used with an open-ended number of 
     *   arguments
     */
    chain(arguments?: any): void
  ...
  class EQ extends p5.Effect {
    ...
    /**
     *   Add a new band. Creates a p5.Filter and strips 
     *   away everything but the raw biquad filter. This 
     *   method returns an abstracted p5.Filter, which can 
     *   be added to p5.EQ.bands, in order to create new EQ 
     *   bands.
     */
    _newBand(freq: number, res: number): any
  }
  class Panner3D {
    /**
     ...
     *   3D space. 
     * 
     *   The position is relative to an  Audio Context 
     *   Listener, which can be accessed by 
  ...
  class SoundLoop {
     ...
     *   SoundLoop
     */
    constructor(callback: () => any, interval?: number|string)
    
    // TODO: Property "musicalTimeMode true if string, false if number", defined in lib/addons/p5.sound.js, is not a valid JS symbol name
    
    // TODO: Property "{Number} [timeSignature] number of quarter notes in a measure (defaults to 4)", defined in lib/addons/p5.sound.js, is not a valid JS symbol name
    
    // TODO: Property "[maxIterations]  defaults to Infinity", defined in lib/addons/p5.sound.js, is not a valid JS symbol name
     ...
     */
    syncedStart(otherLoop: any, timeFromNow?: number): void
    
    /**
     *   Updates frequency value, reflected in next 
     *   callback
     */
    _update(): void
    
    /**
     *   Calculate the frequency of the clock's callback 
     *   based on bpm, interval, and timesignature
     */
    _calcFreq(): number
    
    /**
     *   Convert notation from musical time format to 
     *   seconds Uses Tone.Time convention
     */
    _convertNotation(value: string): number
  ...
  class Compressor extends p5.Effect {
     ...
     *   sources in addition to the master output.  
     * 
     *   This class extends p5.Effect.
     *   Methods amp(), chain(), drywet(), connect(), and 
     *   disconnect() are available.
     ...
     *   audioParams
     */
    process(src: any, attack?: number, knee?: number, ratio?: number, threshold?: number, release?: number): void
  ...
  class AudioVoice {
    ...
    /**
     *   This method converts midi notes specified as a 
     *   string "C4", "Eb3"...etc to frequency
     */
    _setNote(note: string): void
  ...
  class MonoSynth {
    ...
    // TODO: Property "{Number} release", defined in lib/addons/p5.sound.js, is not a valid JS symbol name
  ...
  class PolySynth {
    ...
    /**
     *   This value must only change as a note is attacked 
     *   or released. Due to delay and sustain times, 
     *   Tone.TimelineSignal is required to schedule the 
     *   change in value.
     */
    _voicesInUse: any
